...
routs.post('/editdata', passport.checkAuthentication, indexcontroller.editdata);
routs.get('/changepassword', passport.checkAuthentication, indexcontroller.changepassword);
routs.post('/passwordData', passport.checkAuthentication, indexcontroller.passwordData);
routs.get('/otp', passport.checkAuthentication, indexcontroller.otp);
routs.post('/otpdata', passport.checkAuthentication, indexcontroller.otpdata);
routs.post('/otpdata', passport.checkAuthentication, indexcontroller.otpdata);
routs.get('/newpassword', passport.checkAuthentication, indexcontroller.newpassword);
